...
RMenu.Add('hs0_bank', 'main', RageUI.CreateMenu("Banque", "Pour accéder à votre compte"))
RMenu.Add('hs0_bank', 'bank', RageUI.CreateSubMenu(RMenu:Get('hs0_bank', 'main'), "Compte", "Voici votre compte en banque."))
...
Citizen.CreateThread(function()
    while true do
        RageUI.IsVisible(RMenu:Get('hs0_bank', 'main'), true, true, true, function()
            ...
            RageUI.Button("Parler au banquier", nil, {RigtLabel = "→→→"},true, function()
            end, RMenu:Get('hs0_bank', 'bank')) 

        end, function()
        end)

        RageUI.IsVisible(RMenu:Get('hs0_bank', 'bank'), true, true, true, function()
            ...
            RageUI.Button("Banque", nil, {RightLabel = argentsolde.."~g~ $"},true, function(Hovered, Active, Selected)
            if (Selected) then   
                verifsolde()
            end
            end)         
